...
- 新幹線・特急・通勤電車・地下鉄・モノレールの全国90車種
- 新幹線・特急は「形式＋愛称」、普通の電車は主な路線を出題
- 小学校2年生でも読めるように、車両名・路線名・会社名・地域名・クイズ用語へふりがなを表示
- ホームは主要4導線だけを表示し、レベル・テーマ選択を折りたたんだ省スクロール設計
...
テストでは、90車種のデータ整合性、画像ライセンス、4択の一意性、難易度別問題、毎日問題の再現性、復習対象の限定、習熟度・称号ロジックを確認します。
